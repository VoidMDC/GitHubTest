...
public class PrintNames : MonoBehaviour {
	...
	private string [] names = {"Ray Millares", "Alexander Villarreal", "Gabriel Cabrera", "William Tang", "Austin Acosta", "Alexander Artigas", "Matthew Monteverde", "Alexander Deluzuriaga, Juan C.Gutierrez"};
